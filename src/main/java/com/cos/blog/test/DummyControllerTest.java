...
// 	userRepository.deleteById(id); // 사용해도 되지만 위험함
		try{
		 ...
		 * IllegalArgumentException("삭제에 실패하였습니다."); });
		 * 
	...
	public User updateUser(@PathVariable int id, @RequestBody User requestUser) {
		// json 데이터를 요청 -> Java Object(MessageConverter의 Jackson라이브러리가 변환해서 받아준다,.)
...
//		userRepository.save(user); 
	...
	} // Transactional 어노테이션을 걸면 updateUser 메소드 종료시에 commit
	...
	public User detail(@PathVariable int id) {
		...
		// 그럼 return null 이 리턴이 되자나.. 그럼 프로그램에 문제가 있지 않겠지?
