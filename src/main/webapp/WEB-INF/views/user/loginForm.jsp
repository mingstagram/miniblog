...
<div class="container">
	<form action="/auth/loginProc" method="POST">
		...
		<div>
			...
			<a class="btn btn-info" href="https://www.facebook.com/v10.0/dialog/oauth?client_id=284427873395875&redirect_uri=http://localhost:8000/auth/facebook/callback&auth_type=rerequest" >Facebook</a>
